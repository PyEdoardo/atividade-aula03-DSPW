...
const livrosDeAutorAposAno = (autor, ano) => livros.filter(livro => livro.autor === autor)
...
// const criarCartoesDeLivros = ({titulo, autor, anoPublicacao}) => 
//     livros.map(livro => `Título: ${titulo} | Autor: ${autor} | Ano: ${anoPublicacao}`);
